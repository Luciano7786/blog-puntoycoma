...
const TarjetaArticulo = ({ articulo }) => {
  ...
  return (
    <div className="group relative bg-ciber-gris border border-gray-800 hover:border-ciber-verde transition-colors duration-300 overflow-hidden rounded flex flex-col h-full">
